...
const runDir = resolve(value('--run-dir', 'benchmarks/automatic-explicit-pilot-run'));
...
// Excluded preflight: one task, one repetition, all three arms. Its quality
// result is never pooled into the frozen 36-run comparison.
const taskCount = 1;
